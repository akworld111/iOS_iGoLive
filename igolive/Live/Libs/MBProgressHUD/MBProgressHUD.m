...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObjectsAndKeys:detailsLabel.font,NSFontAttributeName, nil] context:nil].size;
