...
- (void)layoutViewControllers
{
  ...
  UIEdgeInsets contentInsets = UIEdgeInsetsMake(headerOffset, 0.0, _containerView.contentInset.top, 0.0);
...
- (void)goSelectedIndex:(NSInteger)newSelectedIndex{
    [self layoutSubViewControllerToSelectedViewController];
    
    UITabBarItem *item = [[_tabBar items] objectAtIndex:newSelectedIndex];
