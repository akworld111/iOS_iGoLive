...
- (void)_setup {
    self.backgroundColor = [UIColor colorWithRed:(239 / 255.f) green:(239 / 255.f) blue:(239 / 255.f) alpha:1.f];
    ...
    _reloadButton = [[UIButton alloc] initWithFrame:self.bounds];
    self.reloadButton.alpha = 0.;
    [self.reloadButton setImage:[UIImage imageNamed:@"h_logo_bg"] forState:UIControlStateNormal];
    [self.reloadButton setImage:[UIImage imageNamed:@"h_logo_bg"] forState:UIControlStateHighlighted];
    [self.reloadButton addTarget:self action:@selector(reloadButtonClicked:) forControlEvents:
     UIControlEventTouchUpInside];
    [self.reloadButton setImageEdgeInsets:UIEdgeInsetsMake(-CGRectGetHeight(self.reloadButton.frame)/3, 0, 0, 0)];
