...
#define ISO_OUTERNON_DATE_FORMAT @"yyyy-MM-dd'T'HH:mm:ss"
...
//		format = ISO8601DateFormatCalendar;
		format = ISO8601DateFormatOuternon;
...
- (NSString *) stringFromDate:(NSDate *)date timeZone:(NSTimeZone *)timeZone {
	switch (self.format) {
        case ISO8601DateFormatOuternon:
			return [self stringFromDate:date formatString:ISO_OUTERNON_DATE_FORMAT timeZone:timeZone];
