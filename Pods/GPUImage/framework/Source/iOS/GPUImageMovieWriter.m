...
- (void)initializeMovieWithOutputSettings:(NSDictionary *)outputSettings;
{
    ...
    */
    ...
    /* eg 10.07.16 */
    NSMutableDictionary * compressionProperties = [[NSMutableDictionary alloc] init];
    [compressionProperties setObject:[NSNumber numberWithInt: 2] forKey:AVVideoMaxKeyFrameIntervalKey];
    [compressionProperties setObject:[NSNumber numberWithInt: 2] forKey:AVVideoMaxKeyFrameIntervalDurationKey];
    
    NSMutableDictionary *mOutputSettings = [NSMutableDictionary dictionaryWithDictionary:outputSettings];
    [mOutputSettings setObject:compressionProperties forKey:AVVideoCompressionPropertiesKey];
    outputSettings = [NSDictionary dictionaryWithDictionary:mOutputSettings];
    /* _eg_ */
